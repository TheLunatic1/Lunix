...
pub fn resolve_symbol(dll: &str, symbol: &str) -> Option<usize> {
    ...
    if dll_upper_match {
        match symbol {
            "ExAllocatePool" => Some(crate::subsystems::nt::ntoskrnl::ExAllocatePool as *const () as usize),
            "ExFreePool" => Some(crate::subsystems::nt::ntoskrnl::ExFreePool as *const () as usize),
            ...
            "KeInitializeEvent" => Some(crate::subsystems::nt::ntoskrnl::KeInitializeEvent as *const () as usize),
            "KeSetEvent" => Some(crate::subsystems::nt::ntoskrnl::KeSetEvent as *const () as usize),
            "KeResetEvent" => Some(crate::subsystems::nt::ntoskrnl::KeResetEvent as *const () as usize),
            "KeClearEvent" => Some(crate::subsystems::nt::ntoskrnl::KeClearEvent as *const () as usize),
            "KeWaitForSingleObject" => Some(crate::subsystems::nt::ntoskrnl::KeWaitForSingleObject as *const () as usize),
            "KeInitializeMutex" => Some(crate::subsystems::nt::ntoskrnl::KeInitializeMutex as *const () as usize),
            "KeReleaseMutex" => Some(crate::subsystems::nt::ntoskrnl::KeReleaseMutex as *const () as usize),
            ...
            "IoAttachDevice" => Some(crate::subsystems::nt::ntoskrnl::IoAttachDevice as *const () as usize),
            "IoAttachDeviceToDeviceStack" => Some(crate::subsystems::nt::ntoskrnl::IoAttachDeviceToDeviceStack as *const () as usize),
            "IoDetachDevice" => Some(crate::subsystems::nt::ntoskrnl::IoDetachDevice as *const () as usize),
            "IoAllocateIrp" => Some(crate::subsystems::nt::ntoskrnl::IoAllocateIrp as *const () as usize),
            "IoFreeIrp" => Some(crate::subsystems::nt::ntoskrnl::IoFreeIrp as *const () as usize),
            "IoAllocateMdl" => Some(crate::subsystems::nt::ntoskrnl::IoAllocateMdl as *const () as usize),
            "IoFreeMdl" => Some(crate::subsystems::nt::ntoskrnl::IoFreeMdl as *const () as usize),
            "MmProbeAndLockPages" => Some(crate::subsystems::nt::ntoskrnl::MmProbeAndLockPages as *const () as usize),
            "MmUnlockPages" => Some(crate::subsystems::nt::ntoskrnl::MmUnlockPages as *const () as usize),
        ...
        match symbol {
            ...
            "HalTranslateBusAddress" => Some(crate::subsystems::nt::hal::HalTranslateBusAddress as *const () as usize),
            "HalAllocateCommonBuffer" => Some(crate::subsystems::nt::hal::HalAllocateCommonBuffer as *const () as usize),
            "HalFreeCommonBuffer" => Some(crate::subsystems::nt::hal::HalFreeCommonBuffer as *const () as usize),
            "KeFlushWriteBuffer" => Some(crate::subsystems::nt::hal::KeFlushWriteBuffer as *const () as usize),
            _ => None,
        }
    } else {
        None
